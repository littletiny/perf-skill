...
> SHECR 方法论：**S**ystematic **H**ypothesis **E**vidence-driven **C**ontrolled **R**easoning
> 版本: 3.0
> 更新时间: 2026-03-03
...
当标签出现在文本中时，其后的内容自动获得更高权重。无需复杂解析，LLM 对 `<P0>`、`<HINT>` 等标记天然敏感。
...
| 字母 | 核心原则 | 含义 |
|------|----------|------|
| **S** | Systematic | 系统性方法，三层架构驱动 |
| **H** | Hypothesis | 三假设准则，延迟收敛 |
| **E** | Evidence-driven | 证据优先，数据说话 |
| **C** | Controlled | 受控收敛，禁止过早下结论 |
| **R** | Reasoning | 逻辑推理，因果追踪 |

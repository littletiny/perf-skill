# Perf Expert 工具参考 (Top-Down + Bottom-Up 混合分析模式)

基于 SPEAR 方法论的 Linux 性能诊断工具集，采用 **Top-Down 宏观切入 + Bottom-Up 微观溯源** 的混合分析模式。
...
### 2.3 analyze-core-distribution —— 核心级负载分析
...
### 6.1 count-process-variety —— 进程风暴检测
